/*
Deployment script for DB_ASP_Epreuve
...
GO
:setvar DatabaseName "DB_ASP_Epreuve"
:setvar DefaultFilePrefix "DB_ASP_Epreuve"
...
GO
ALTER TABLE [dbo].[Jeux_Utilisateur]
    ADD CONSTRAINT [FK_Utilisateur_Jeux_Utilisateur] FOREIGN KEY ([Utilisateur_Id]) REFERENCES [dbo].[Utilisateur] ([Utilisateur_Id]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[Jeux_Utilisateur]
    ADD CONSTRAINT [FK_Utilisateur_Jeux_Jeux] FOREIGN KEY ([Jeu_Id]) REFERENCES [dbo].[Jeux] ([Jeu_Id]);
